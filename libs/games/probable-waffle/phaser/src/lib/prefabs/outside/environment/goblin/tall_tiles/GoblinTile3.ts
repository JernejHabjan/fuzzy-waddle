...
export default class GoblinTile3 extends Phaser.GameObjects.Image {

  constructor(scene: Phaser.Scene, x?: number, y?: number, texture?: string, frame?: number | string) {
    super(scene, x ?? 32, y ?? 48, texture || "environment_1", frame ?? "goblin/tall tiles/dark_3.png");
  ...
  /* START-USER-CODE */
  override name = ObjectNames.GoblinTile3;
