...
const ANIM_MUMMY_IDLE_4 = "mummy_idle_4";
const ANIM_MUMMY_IDLE_5 = "mummy_idle_5";
const ANIM_MUMMY_IDLE_6 = "mummy_idle_6";
...
export const ANIM_MUMMY_DEFINITION: AnimationDefinitionMap = {
  [AnimationType.Idle]: {
    north: { key: ANIM_MUMMY_IDLE_3 },
    south: { key: ANIM_MUMMY_IDLE_5 },
    west: { key: ANIM_MUMMY_IDLE_4 },
    east: { key: ANIM_MUMMY_IDLE_6 }
  },
  [AnimationType.Walk]: {
