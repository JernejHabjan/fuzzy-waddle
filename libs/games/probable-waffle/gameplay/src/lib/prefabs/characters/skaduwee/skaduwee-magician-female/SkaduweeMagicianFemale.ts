...
export default class SkaduweeMagicianFemale extends Phaser.GameObjects.Container {
	...
	constructor(scene: Phaser.Scene, x?: number, y?: number) {
		...
		const skaduwee_magician_female_idle_down = scene.add.sprite(0, -25.571183923696843, "magician_female_lvl1_idle", 4);
		skaduwee_magician_female_idle_down.play("magician_female_lvl1_idle_2");
