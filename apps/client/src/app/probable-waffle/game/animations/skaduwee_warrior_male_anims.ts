...
const ANIM_SKADUWEE_WARRIOR_MALE_ISLASH_UP = "skaduwee_warrior_male_islash_up";

const ANIM_SKADUWEE_WARRIOR_MALE_ISLASH_LEFT = "skaduwee_warrior_male_islash_left";

const ANIM_SKADUWEE_WARRIOR_MALE_ISLASH_DOWN = "skaduwee_warrior_male_islash_down";

const ANIM_SKADUWEE_WARRIOR_MALE_ISLASH_RIGHT = "skaduwee_warrior_male_islash_right";
...
export const ANIM_SKADUWEE_WARRIOR_MALE_DEFINITION: AnimationDefinitionMap = {
  ...
  [AnimationType.InvertedSlash]: {
    north: { key: ANIM_SKADUWEE_WARRIOR_MALE_ISLASH_UP },
    south: { key: ANIM_SKADUWEE_WARRIOR_MALE_ISLASH_DOWN },
    west: { key: ANIM_SKADUWEE_WARRIOR_MALE_ISLASH_LEFT },
    east: { key: ANIM_SKADUWEE_WARRIOR_MALE_ISLASH_RIGHT }
  },
  [AnimationType.Smash]: {
