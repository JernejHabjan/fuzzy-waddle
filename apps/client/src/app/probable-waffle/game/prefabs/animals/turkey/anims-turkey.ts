...
export const ANIM_TURKEY_DEFINITION: AnimationDefinitionMap = {
  [AnimationType.Idle]: {
    northwest: { key: ANIM_TURKEY_TURKEY_IDLE_BACK_TURKEY_IDLE_BACK },
    southeast: { key: ANIM_TURKEY_TURKEY_IDLE_FRONT_TURKEY_IDLE_FRONT },
    southwest: { key: ANIM_TURKEY_TURKEY_IDLE_LEFT_TURKEY_IDLE_LEFT },
    northeast: { key: ANIM_TURKEY_TURKEY_IDLE_RIGHT_TURKEY_IDLE_RIGHT },
  },
  [AnimationType.Walk]: {
    northwest: { key: ANIM_TURKEY_TURKEY_WALK_BACK_TURKEY_WALK_BACK },
    southeast: { key: ANIM_TURKEY_TURKEY_WALK_FRONT_TURKEY_WALK_FRONT },
    southwest: { key: ANIM_TURKEY_TURKEY_WALK_LEFT_TURKEY_WALK_LEFT },
    northeast: { key: ANIM_TURKEY_TURKEY_WALK_RIGHT_TURKEY_WALK_RIGHT },
  },
};
