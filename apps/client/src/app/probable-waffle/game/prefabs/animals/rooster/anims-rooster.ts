...
export const ANIM_ROOSTER_DEFINITION: AnimationDefinitionMap = {
  [AnimationType.Idle]: {
    north: { key: ANIM_ROOSTER_ROOSTER_IDLE_BACK_ROOSTER__BACK_IDLE },
    south: { key: ANIM_ROOSTER_ROOSTER_IDLE_FRONT_ROOSTER__FRONT_IDLE },
    west: { key: ANIM_ROOSTER_ROOSTER_IDLE_LEFT_ROOSTER__LEFT_IDLE },
    east: { key: ANIM_ROOSTER_ROOSTER_IDLE_RIGHT_ROOSTER__RIGHT_IDLE },
  },
  [AnimationType.Walk]: {
    north: { key: ANIM_ROOSTER_ROOSTER_WALK_BACK_ROOSTER__BACK_WALK },
    south: { key: ANIM_ROOSTER_ROOSTER_WALK_FRONT_ROOSTER__FRONT_WALK },
    west: { key: ANIM_ROOSTER_ROOSTER_WALK_LEFT_ROOSTER__LEFT_WALK },
    east: { key: ANIM_ROOSTER_ROOSTER_WALK_RIGHT_ROOSTER__RIGHT_WALK },
  },
};
