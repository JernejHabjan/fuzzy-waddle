...
export default class CursedLandRockEyes1 extends Phaser.GameObjects.Sprite {
  ...
  //   - cursed_land/Rock_eyes_shadow1_2.png
  //   - cursed_land/Rock_eyes_shadow1_3.png
  //   - cursed_land/Rock_eyes_shadow1_4.png
  //   - cursed_land/Rock_eyes_shadow1_5.png
