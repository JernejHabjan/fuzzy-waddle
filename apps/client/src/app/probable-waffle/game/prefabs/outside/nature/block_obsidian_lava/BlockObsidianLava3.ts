...
export default class BlockObsidianLava3 extends Phaser.GameObjects.Container {
	...
	constructor(scene: Phaser.Scene, x?: number, y?: number) {
		...
		const outside_nature_block_obsidian_lava_3 = scene.add.image(0, -17.87410141979456, "outside", "nature/block_obsidian_lava/3.png");
