...
export default class BlockStoneTopLeft extends Phaser.GameObjects.Image {

	constructor(scene: Phaser.Scene, x?: number, y?: number, texture?: string, frame?: number | string) {
		super(scene, x ?? 32, y ?? 48.14660195684367, texture || "outside", frame ?? "nature/block_stone_grass/top_left.png");
