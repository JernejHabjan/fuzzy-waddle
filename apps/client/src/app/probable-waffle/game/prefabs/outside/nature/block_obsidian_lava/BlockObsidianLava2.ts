...
export default class BlockObsidianLava2 extends Phaser.GameObjects.Container {
	...
	constructor(scene: Phaser.Scene, x?: number, y?: number) {
		...
		// outside_nature_block_obsidian_lava_2
		const outside_nature_block_obsidian_lava_2 = scene.add.image(0, -17.87410141979456, "outside", "nature/block_obsidian_lava/2.png");
		outside_nature_block_obsidian_lava_2.setOrigin(0.5, 0.470717165742086);
		this.add(outside_nature_block_obsidian_lava_2);
