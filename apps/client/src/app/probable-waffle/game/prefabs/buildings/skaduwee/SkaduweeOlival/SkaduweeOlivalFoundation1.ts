...
export default class SkaduweeOlivalFoundation1 extends Phaser.GameObjects.Container {

	constructor(scene: Phaser.Scene, x?: number, y?: number) {
		super(scene, x ?? 16, y ?? 55);

		this.setInteractive(new Phaser.Geom.Rectangle(-15.99154048826449, -0.5352534599789038, 32, 10), Phaser.Geom.Rectangle.Contains);
