...
/* START-USER-IMPORTS */
import { ANIM_FROST_FORGE_FLAME } from "./anims-frost-forge";
/* END-USER-IMPORTS */
...
export default class FrostForgeLevel1 extends Phaser.GameObjects.Container {
  constructor(scene: Phaser.Scene, x?: number, y?: number) {
    ...
    this.frost_forge_flame = frost_forge_flame;
  ...
  private frost_forge_flame: Phaser.GameObjects.Sprite;
  ...
  start() {
    ...
    this.frost_forge_flame.play(ANIM_FROST_FORGE_FLAME);
  }
