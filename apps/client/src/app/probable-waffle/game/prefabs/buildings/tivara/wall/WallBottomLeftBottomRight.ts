...
export default class WallBottomLeftBottomRight extends ActorContainer {
  constructor(scene: Phaser.Scene, x?: number, y?: number) {
    ...
    this.on("pointerdown", () => {
      ...
      setTimeout(() => {
        buildings_tivara_wall_bottom_left_bottom_right.clearTint();
      }, 1000);
    });
    /* END-USER-CTR-CODE */
  }
