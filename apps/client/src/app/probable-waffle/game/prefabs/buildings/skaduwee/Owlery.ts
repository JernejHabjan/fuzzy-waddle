...
export default class Owlery extends Phaser.GameObjects.Container {
	...
	constructor(scene: Phaser.Scene, x?: number, y?: number) {
		...
		const skaduwee_buildings_owlery_owl = scene.add.sprite(3, -134, "factions", "buildings/skaduwee/owlery/owlery-owl/owlery-owl-0.png");
