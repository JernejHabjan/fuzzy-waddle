...
export default class GameActionsLayer extends ProbableWaffleScene {
  ...
  editorCreate(): void {
    ...
    game_action_quit.setInteractive(new Phaser.Geom.Rectangle(-42, -13, 85.7117848223629, 25.429332302435576), Phaser.Geom.Rectangle.Contains);
    ...
    text_3.text = "Quit";
    text_3.setStyle({ "align": "center", "color": "#000000ff", "fontFamily": "ARCADECLASSIC", "fontSize": "14px", "resolution": 10 });
    ...
    game_action_load.setInteractive(new Phaser.Geom.Rectangle(-42, -13, 85.7117848223629, 25.429332302435576), Phaser.Geom.Rectangle.Contains);
    ...
    text_4.text = "Load";
    text_4.setStyle({ "align": "center", "color": "#000000ff", "fontFamily": "ARCADECLASSIC", "fontSize": "14px", "resolution": 10 });
    ...
    game_action_save.setInteractive(new Phaser.Geom.Rectangle(-42, -13, 85.7117848223629, 25.429332302435576), Phaser.Geom.Rectangle.Contains);
    ...
    text_5.text = "Save";
    text_5.setStyle({ "align": "center", "color": "#000000ff", "fontFamily": "ARCADECLASSIC", "fontSize": "14px", "resolution": 10 });
    ...
    game_action_settings.setInteractive(new Phaser.Geom.Rectangle(-42, -13, 85.7117848223629, 25.429332302435576), Phaser.Geom.Rectangle.Contains);
    ...
    text_2.setStyle({ "align": "center", "color": "#000000ff", "fontFamily": "ARCADECLASSIC", "fontSize": "14px", "resolution": 10 });
    ...
    game_action_restart.setInteractive(new Phaser.Geom.Rectangle(-42, -13, 85.7117848223629, 25.429332302435576), Phaser.Geom.Rectangle.Contains);
    ...
    text.text = "Restart";
    text.setStyle({ "align": "center", "color": "#000000ff", "fontFamily": "ARCADECLASSIC", "fontSize": "14px", "resolution": 10 });
    ...
    game_action_continue.setInteractive(new Phaser.Geom.Rectangle(-42, -13, 85.7117848223629, 25.429332302435576), Phaser.Geom.Rectangle.Contains);
    ...
    text_1.setStyle({ "align": "center", "color": "#000000ff", "fontFamily": "ARCADECLASSIC", "fontSize": "14px", "stroke": "#ffffffff", "resolution": 10 });
