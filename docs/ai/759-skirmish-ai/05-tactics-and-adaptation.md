...
The deterministic Stage 13 harness must explicitly cover assembly, rally, advance, defense, regroup, recovery, domain splitting, transport handoff, rampart reinforcement and withdrawal, independently observed useful-effect progress, casualty accounting and deadline-forced mission resolution. Its authored variants also cover economy/production raids, air/naval splitting, retreat/relaunch oscillation, expected-impact overkill prevention, bounded heal/spell support and finite assembly/effect deadlines. Register pure authored fixtures separately from authoritative runtime fixtures: authored coverage is runnable in the Stage 15 ladder but must not satisfy the release runner's runtime-counterpart requirement by itself.
